export default {
  ...
  active: false,
  route: {
    path: '/project/change-for-a-dollar',
    strict: true,
  },
  id: 'tp5',
  type: 'technology',
  ...
  description:
    'Created end-to-end by Usful, the Change for a Dollar mobile and web platform infuses innovation into the concept of charitable giving; it rounds up every purchase made to the nearest dollar and donates the change to the user’s choice of charity.',
  impact:
